...
export function setupSettingsListeners(canvas) {
  const notifyReset = () => settingsEvents.dispatchEvent(new Event('reset'));
  const notifyTheme = () => settingsEvents.dispatchEvent(new Event('theme-change'));

  inputs.darkMode.onchange = event => {
